    ...
    <section className="relative py-24 px-6 overflow-hidden" style={{ background: 'transparent' }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-purple-200/80 leading-tight mt-1">
        ...
        >
          <div className="bg-[#2D0878]/60 border border-purple-500/35 rounded-3xl overflow-hidden shadow-[0_30px_80px_rgba(120,50,220,0.4)] backdrop-blur-sm">
            <div className="bg-[#1a0045]/80 px-4 py-3 flex items-center gap-2 border-b border-purple-600/30">
        ...
        >
          <p className="text-purple-200/80 text-base md:text-lg">
            Experience <span className="font-bold text-white">QuantumApps.AI</span> in real
            government workflows.
          </p>
          <Button variant="orange" className="px-10 py-4 text-base">
