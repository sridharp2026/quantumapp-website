    ...
    />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-28 pb-16">
        <motion.h1
          ...
          className="text-[76px] font-[200] capitalize drop-shadow-[11px_10px_7.6px_rgba(0,0,0,0.35)]"
        >
        ...
        <motion.h1
          ...
          className="text-[49px] leading-[1.07] tracking-tight mb-8"
        >
        ...
        <motion.p
          ...
          className="text-[18px] tracking-tight mb-8 capitalize"
        >
